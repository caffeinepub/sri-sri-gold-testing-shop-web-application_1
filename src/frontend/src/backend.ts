...
export class Backend implements backendInterface {
    ...
    async addAppointment(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async addCustomer(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async addFeedbackEntry(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addFeedbackEntry(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addResetPasscode(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addResetPasscode(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async finalizePasswordReset(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.finalizePasswordReset(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllCustomersPublicView(): Promise<Array<CustomerPublicView>> {
        if (this.processError) {
            try {
    ...
    async getAllEntries(): Promise<Array<FeedbackEntry>> {
        if (this.processError) {
            try {
    ...
    async getAppointments(): Promise<Array<AppointmentRequest>> {
        if (this.processError) {
            try {
    ...
    async requestPasswordReset(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.requestPasswordReset(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async verifyResetPasscode(arg0: string, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.verifyResetPasscode(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
